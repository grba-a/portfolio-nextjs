...
/*
 * Znakovi društvenih mreža.
 *
 * Zaseban set: brendovi su PUNE plohe, a gornji `base` crta linijom —
 * pomiješano bi izgledalo kao dvije različite ikonografije u istom podnožju.
 * Bez `aria-hidden` iznimke: naziv mreže nosi poveznica oko ikone.
 */
const brand = {
  width: 18,
  height: 18,
